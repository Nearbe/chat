<document>
  <metadata>
    <title>AI Agents Team — Реестр агентов проекта Chat</title>
    <version>1.0</version>
...
| **metrics**                       | Analytics                                        |
    ...
    <section name="agent_interaction">
